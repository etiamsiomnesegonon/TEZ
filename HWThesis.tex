...
% Name of the author
\newcommand{\auth}{Thibault L.}   
% Title of Thesis                
\newcommand{\thesistitle}{Manipulation of uncooperative objects in zero-gravity with modular self-reconfigurable robot}
% Degree  
\newcommand{\degree}{Doctor of Philosophy} 
% Date submitted
\newcommand{\supdate}{August 2020}            
...
\input{Introduction}
\input{List_of_Notation}
\input{Background}
\input{Stability_Study}
\input{Envelopment_Task}
\input{Arm_Stabilisation}
\input{Conclusion}
